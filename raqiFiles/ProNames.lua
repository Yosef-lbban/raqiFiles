...
DevAbs:set(raqi.."Abs:ProNames:Num"..msg.chat_id_,Num)
else
send(msg.chat_id_, msg.id_,'⌁︙ميزة التوحيد معطله يرجى تفعيلها')
end
end
...
if DevAbs:get(raqi.."Abs:ProNames:Txt"..msg.chat_id_) then
local ProNamesTxt = DevAbs:get(raqi.."Abs:ProNames:Txt"..msg.chat_id_)
local ProNamesNum = DevAbs:get(raqi.."Abs:ProNames:Num"..msg.chat_id_) or 5
...
if DevAbs:get(raqi.."Abs:Lock:ProNames"..msg.chat_id_) and DevAbs:get(raqi.."Abs:ProNames:Txt"..msg.chat_id_) then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result and result.first_name_ then 
if result.first_name_:match("(.*)"..DevAbs:get(raqi.."Abs:ProNames:Txt"..msg.chat_id_).."(.*)") then 
DevAbs:srem(raqi..'Abs:Muted:'..msg.chat_id_, msg.sender_user_id_)
else
local ProNamesTxt = DevAbs:get(raqi.."Abs:ProNames:Num"..msg.chat_id_) or 5
local UserNum = DevAbs:get(raqi.."Abs:ProNames:UserNum"..msg.chat_id_..msg.sender_user_id_) or 0
...
DevAbs:del(raqi.."Abs:ProNames:UserNum"..msg.chat_id_..msg.sender_user_id_)
...
DevAbs:set(raqi.."Abs:Lock:ProNames"..msg.chat_id_,true)
end
if text == "تعطيل التوحيد" and Constructor(msg) then
send(msg.chat_id_, msg.id_, '⌁︙تم تعطيل توحيد المجموعه')
DevAbs:del(raqi.."Abs:Lock:ProNames"..msg.chat_id_)
end
end
